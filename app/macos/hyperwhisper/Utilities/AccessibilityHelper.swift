...
public class AccessibilityHelper {
    ...
    /// TEST SEAM. Always nil in the app. When set, `executePasteAsync` uses it in
    /// place of `hasAccessibilityPermission()`, so a test can reach the branches
    /// after the permission guard on a CI Mac that never grants Accessibility.
