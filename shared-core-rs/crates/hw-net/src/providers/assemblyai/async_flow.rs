//! Steps 1–3 of AssemblyAI's async transcription workflow: upload → create →
//! poll. See the parent module's (`super`) doc comment for the overall
//! contract, endpoints, and parity references.
...
fn base(params: &TranscribeParams) -> String {
    params
        ...
        .unwrap_or_else(|| super::BASE_URL.to_string())
}
