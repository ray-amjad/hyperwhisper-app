...
// reserved. Must match cost-calculator.ts's ASSEMBLYAI_SYNC_COST_PER_AUDIO_MINUTE.
export const ASSEMBLYAI_SYNC_ESTIMATED_USD_PER_MINUTE = 0.45 / 60; // $0.0075/min
