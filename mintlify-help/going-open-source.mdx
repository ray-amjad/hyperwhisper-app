...
On June 30, 2026, HyperWhisper went open source under Apache-2.0. The public
[GitHub repository](https://github.com/ray-amjad/hyperwhisper-app) contains the
macOS, Windows, and Linux apps. It also contains the Cloud transcription
backend, this documentation site, and the marketing site.
