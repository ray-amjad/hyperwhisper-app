...
Sound effects volume can be adjusted independently from your system volume on a 0.0–1.0 scale. The volume control is fully implemented but does not yet have a slider in the Settings UI — it defaults to 1.0 (full volume). A volume slider will be added in an upcoming release.
