...
The volume of the sound effects is separate from the system volume. The scale is 0.0 to 1.0. The Settings window does not show a volume slider yet, and the volume stays at the default value of 1.0 (full volume). A future release will add the slider.
