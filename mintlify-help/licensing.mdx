...
Open the **HyperWhisper Cloud** panel from the app sidebar (or **Settings → HyperWhisper Cloud**) to add credits. Clicking it opens the checkout page in your browser.
...
<Steps>
  <Step title="Deactivate on the old machine (recommended)">
    Open **Settings → HyperWhisper Cloud → Deactivate** on the machine you're leaving. This frees the activation slot.
  </Step>
