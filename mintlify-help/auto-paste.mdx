...
<Note>
  This page describes Auto Paste on **macOS**, which relies on the Accessibility permission covered below. Windows has a fully equivalent Auto Paste feature that works differently — it uses UI Automation and does **not** require the Accessibility permission described on this page. See the Windows tab under [Text Output & Formatting → Auto Paste](/output-settings#auto-paste) for the Windows-specific details.
</Note>
