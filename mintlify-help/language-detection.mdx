...
| **Meta Muse Voice Transcribe** (via HyperWhisper Cloud) | 25 extensively evaluated languages. Meta's Model API reference does not publish a closed code list |
...
- **Meta Muse Voice Transcribe** takes a language name for biasing. HyperWhisper Cloud maps a known picker code to that name. It sends no language bias for **Automatic** or for a code that it cannot map.
