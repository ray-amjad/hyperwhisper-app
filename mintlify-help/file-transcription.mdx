...
<Tabs>
  <Tab title="macOS">
    ...
    The **Microsoft MAI-Transcribe** engine on HyperWhisper Cloud accepts WAV, MP3, and FLAC only. This applies to both of its models, **MAI-Transcribe 2** and **MAI-Transcribe 1.5**. macOS keeps your recordings as M4A, and it converts an imported video to M4A. The server thus refuses the upload.
    ...
    <Warning>
      ...
      | Google Gemini | 14 MB |
      | Google Gemini 3.5 Transcribe | 14 MB |
      | Microsoft MAI-Transcribe (both models) | 300 MB |
