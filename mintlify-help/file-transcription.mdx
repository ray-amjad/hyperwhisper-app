...
Windows and Linux accept `.wav`, `.mp3`, and `.m4a` imports for a Muse mode. They convert the input to a 16 kHz mono PCM WAV before the upload. They then check the 32 MB and 10-minute limits on the converted file.
