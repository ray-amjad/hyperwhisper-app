...
| **NVIDIA Parakeet** | macOS · Windows | English (V2) · 25 European on macOS and 26 European on Windows (V3) | Fastest accurate on-device transcription for English and European languages. |
...
| Model | Size (macOS) | Size (Windows) | Languages | Best for |
| --- | --- | --- | --- | --- |
| Parakeet V2 (English) | 474 MB | 661 MB | English only | Fastest accurate English transcription |
| Parakeet V3 (Multilingual) | 494 MB | 671 MB | 25 European (macOS) · 26 European (Windows) | Multilingual European dictation |
...
| Windows | 26 | English, German, Spanish, French, Italian, Portuguese, Dutch, Polish, Romanian, Swedish, Danish, Finnish, Norwegian, Czech, Slovak, Hungarian, Croatian, Slovenian, Bulgarian, Ukrainian, **Greek**, Lithuanian, Latvian, Estonian, **Catalan**, **Basque** |

<Warning>
  Russian and Serbian are on macOS only. Greek, Catalan, and Basque are on Windows only. If you dictate one of these 5 languages with Parakeet V3, do not expect the same result on the other platform. Use Whisper or a cloud model when you need the same coverage on both.
</Warning>
