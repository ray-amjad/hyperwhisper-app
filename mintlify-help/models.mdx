...
| **High** | Grok STT (xAI), Microsoft MAI-Transcribe, Google Gemini 3.5 Transcribe, Meta Muse Voice Transcribe | Good multilingual accuracy at low cost |
...
Muse is a HyperWhisper Cloud-only model. It costs 3 credits per audio minute. The Model Library marks code switching, endpointing, context bias, language bias, turn-level timestamps, and speaker diarization as supported. It marks word-level timestamps as not supported.
...
**OpenAI · Groq · Deepgram · AssemblyAI · ElevenLabs · Mistral · Soniox · Google Gemini · Google Gemini 3.5 Transcribe · xAI (Grok)**
...
| **xAI (Grok)** | Yes | Grok 4.3, Grok 4.5, and Grok 4.6. High accuracy with low latency |
...
| Grok 4 and Grok 4.1 Fast (xAI) | Grok 4.3 |
