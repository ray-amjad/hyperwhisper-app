...
| **Groq** | Yes | Very fast inference with GPT OSS and Kimi K2 models |
| **xAI (Grok)** | Yes | Grok 4.3 and Grok 4.5. High accuracy with low latency |
| **Cerebras** | Yes | Very fast inference with GPT OSS, Llama 3.1, Qwen, and Z.ai models |
| **Mistral** | Yes | Good for many languages. Mistral Small, Nemo, and Medium 3.5 |
