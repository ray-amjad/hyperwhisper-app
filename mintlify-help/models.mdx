...
<Note>
  Deepgram and AssemblyAI also expose medical-tuned model variants (Deepgram Nova-2 Medical and Nova-3 Medical, AssemblyAI Universal-2 Medical and Universal-3 Pro Medical, plus Universal-3.5 Pro Medical on macOS) in the Model Library / Mode editor on both platforms, alongside their general-purpose models.
...
| **Cerebras** | Yes | Very fast inference with GPT OSS, Llama 3.1, and Qwen models |
