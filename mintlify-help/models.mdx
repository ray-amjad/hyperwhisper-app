...
<Tabs>
  ...
  <Tab title="Windows">
    Local LLM post-processing is available on **Windows x64 and ARM64**. GPU acceleration on x64 uses NVIDIA CUDA and discrete AMD/Intel GPUs via Vulkan; integrated GPUs and ARM64 fall back to CPU.
