...
<AccordionGroup>
  ...
  <Accordion title="Insufficient credits or quota exceeded">
    ...
    **For HyperWhisper Cloud:** Top up credits from the billing dashboard (accessible via **Settings → Credits**). See [Pricing & Cloud Credits](/licensing) for credit rates.
...
<AccordionGroup>
  ...
  <Accordion title="Model protected / license required">
    ...
    **Fix:** Check your license status in **Settings → License**. If your license has expired or does not include the model tier, renew it or contact [support@hyperwhisper.com](mailto:support@hyperwhisper.com). See [Pricing & Cloud Credits](/licensing).
  </Accordion>
</AccordionGroup>
