...
- **Google Chirp 3** (via HyperWhisper Cloud) — HyperWhisper sends them as phrase-list biasing. The app sends at most the first 100 terms. Google recommends a short list, because a long list can make the words that are not in the list less accurate.
