...
- **Google Chirp 3** (via HyperWhisper Cloud) — HyperWhisper sends them as phrase-list biasing, to a maximum of 1000 terms. Google recommends fewer terms, because a long list can make the words that are not in the list less accurate.
