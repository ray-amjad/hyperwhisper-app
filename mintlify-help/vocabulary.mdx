...
- **ElevenLabs** — the app sends the terms as repeated `keyterms` multipart form fields. Scribe v2 is the only ElevenLabs model. The limit is 100 terms, and the app drops terms longer than 50 characters.
