...
- **AssemblyAI** — the app sends the terms as key-term context, up to 200 terms for most models. The limit is 1000 terms for the Universal-3-Pro model. The app drops phrases longer than 6 words.
