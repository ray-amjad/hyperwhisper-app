...
<Note>
  HyperWhisper removes filler words from English transcripts only, on both macOS and Windows, for regular (mode-based) transcription and during [streaming](/streaming-settings#how-streaming-differs-from-modes).
</Note>
