...
<Note>
  On macOS, filler-word removal only runs on English transcripts. On Windows, filler words are stripped regardless of the transcript's language.
</Note>
...
- **The first-person pronoun "I" is preserved** — "I", "I'm", "I'll", "I've", and "I'd" (including curly-apostrophe forms) are never lowercased, even mid-sentence.
