...
- `wss://transcribe-prod-v2.hyperwhisper.com/ws/streaming-deepgram` - [Streaming transcription](/streaming-settings) with HyperWhisper Cloud as the streaming provider

<Note>
  The streaming endpoint is a WebSocket. If your firewall permits HTTPS but stops the WebSocket upgrade, batch transcription operates correctly and streaming transcription does not connect.
</Note>
