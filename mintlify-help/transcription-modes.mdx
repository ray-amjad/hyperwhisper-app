...
<Note>
  One mode is your **default mode**, and its name is fixed: when you edit it, the **Name** field is not editable. Every other mode can be renamed. The default mode is called **Default** on macOS and **Hyper** on Windows.
</Note>
