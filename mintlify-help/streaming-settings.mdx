...
| --- | --- |
| macOS | All eight |
| Windows | HyperWhisper Cloud, Deepgram, ElevenLabs, OpenAI, xAI, Gemini 3.5 Transcribe |
| Linux | All eight |
...
<Tabs>
  <Tab title="macOS">
    The language picker appears in the **Language** section, below the Engine card. The available choices depend on the provider that you select. For cloud providers, the **Automatic** option lets the server detect the language from your audio. When you select **Automatic**, vocabulary boosting is off for HyperWhisper Cloud and Deepgram. It stays on for xAI.
