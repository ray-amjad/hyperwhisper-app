...
The report holds measurements only. **It holds no audio and no text.** It holds:

- Whether the measurement worked, and the error if it did not
- The length of the recording, in seconds, and the size of the file, in bytes
- The file name extension, the sample rate, and the number of channels
- The peak level and the average level, in dBFS, and how much of the recording is above the silence threshold
- The number of audio samples that the app decoded
- The name of your mode, and the name of your selected input device
- Whether the automatic microphone boost failed

On **Windows**, the report also holds the preset of the mode, the name of the engine, the path of the audio file, and the identifier, the status code, and the answer time of the cloud request.
