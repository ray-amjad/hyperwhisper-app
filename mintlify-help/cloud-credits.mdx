...
**A different model.** Each provider offers more than one model, and each model has its own rate. For example, OpenAI GPT-4o Mini Transcribe costs approximately half of OpenAI GPT-4o Transcribe. Select the model in the Model row of the mode editor.
