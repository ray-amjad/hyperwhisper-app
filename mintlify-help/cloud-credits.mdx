...
You must have an active Pro license to purchase credits. Two preset amounts are available, or you can enter a custom amount:
...
<Steps>
  <Step title="Open the credits purchase page">
    <Tabs>
      <Tab title="macOS">
        In **Settings → HyperWhisper Cloud**, click **Manage Credits**. This opens [hyperwhisper.com/credits](https://www.hyperwhisper.com/credits) in your browser with your license pre-filled.
      </Tab>
      <Tab title="Windows">
        In **Settings → HyperWhisper Cloud**, click **Manage Credits**. This opens [hyperwhisper.com/credits](https://www.hyperwhisper.com/credits) in your browser with your license pre-filled.
      </Tab>
  ...
  <Step title="Choose a tier and complete checkout">
    Select the $5 or $10 preset, or enter a custom amount from $5 to $500. You will be taken to a Stripe Checkout page to enter your payment details. Promotion codes are accepted.
  </Step>
...
Once your Pro license is active, a **Manage Billing** button appears in **Settings → HyperWhisper Cloud** (on both macOS and Windows). Clicking it opens your account dashboard at [hyperwhisper.com/user](https://www.hyperwhisper.com/user), where you can:
