...
<Note>
  A non-refundable 6% processing fee is added on top of the credit value at checkout — for example, a $5 purchase (5,000 credits) charges $5.30 total. The fee is shown as a separate line item before you pay.
</Note>
...
<Steps>
  <Step title="Open the credits purchase page">
    <Tabs>
      <Tab title="macOS">
        If you already have an account key, click **Manage Credits** in **Settings → HyperWhisper Cloud** — this opens [hyperwhisper.com/credits](https://www.hyperwhisper.com/credits) with your key pre-filled, taking you to your dashboard to top up. Otherwise, visit [hyperwhisper.com/credits](https://www.hyperwhisper.com/credits) directly to buy credits as a guest.
      </Tab>
      <Tab title="Windows">
        Same flow as macOS: **Manage Credits** in **Settings → HyperWhisper Cloud** pre-fills your existing key, or visit [hyperwhisper.com/credits](https://www.hyperwhisper.com/credits) directly if you don't have one yet.
      </Tab>
    </Tabs>
  </Step>
