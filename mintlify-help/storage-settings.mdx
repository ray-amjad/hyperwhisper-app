...
<Note>
  Linux uses its fixed XDG recordings folder and canonical WAV files. The Linux app does not currently offer a custom-folder picker or M4A conversion because cleanup and local API access enforce ownership within this fixed app directory. Use **Open recordings folder** to open it in your file manager.
</Note>
