...
This setting has its own picker in **Settings → Storage**, below **Compress recordings to M4A**. The other settings on this page do not have a picker. Select a preset from the dropdown. You do not need to edit a backup file. For the full Storage panel, read [Storage Settings](/storage-settings).
