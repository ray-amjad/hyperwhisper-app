...
<Tabs>
  <Tab title="macOS">
    ...
    <Note>
      If you installed HyperWhisper via Homebrew (`brew install --cask hyperwhisper`), automatic update checks are force-disabled regardless of this setting — Homebrew manages upgrades itself via `brew upgrade`.
    </Note>
  </Tab>
  <Tab title="Windows">
