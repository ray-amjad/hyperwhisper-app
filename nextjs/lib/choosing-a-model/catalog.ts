...
const CLOUD_MODELS_RAW = [
  ...
  { id: "assemblyAI:dictation", name: "Dictation (built-in cleanup, up to 120s)", vendorLabel: "AssemblyAI", vendor: "AssemblyAI", sttProvider: "assemblyai", modelId: "dictation", credits: 10.3333333333, wer: null, speedFactor: null, languages: 32, streaming: false, customVocabulary: true, preview: false, isDefault: false, byok: true },
