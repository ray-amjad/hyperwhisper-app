...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
    <div style="background-color: #f9fafb; border-radius: 8px; padding: 32px; margin-bottom: 24px;">
        ...
        <p style="margin-bottom: 16px; color: #4b5563;">Thank you for purchasing ${productName}! Your license key is ready and waiting for you below.</p>
    ...
    <p style="color: #6b7280; font-size: 14px; margin-bottom: 24px;">
        <strong>Need help?</strong> Email us at <a href="mailto:${supportEmail}" style="color: #2563eb;">${supportEmail}</a> or visit our <a href="https://hyperwhisper.com/user" style="color: #2563eb;">customer portal</a> to access your license key, receipt, and invoice.
    </p>
...
Thank you for purchasing ${productName}! Your license key is ready:
